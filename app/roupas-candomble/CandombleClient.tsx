        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              { title: "Pano da Costa (Alaká) e Proas", desc: "Tecidos estruturados e nobres, com barra e comprimento adequados ao seu biotipo." },
              ...
              { title: "Pano de Cabeça (Ojá)", desc: "Confeccionado no tecido correto, com largura ideal para amarrações firmes e elegantes." },
