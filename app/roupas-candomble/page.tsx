...
export const metadata: Metadata = {
  ...
  keywords: "roupas de candomblé sob medida, pano da costa bordado, camisu candomblé, saia de alodê, kit obrigação candomblé, trajes para saída de santo, confecção afro-religiosa SP, roupas para orixá",
};
